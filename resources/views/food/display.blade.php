    ...
    <x-app-layout>
        <div class="p-3 w-full flex items-center justify-center">
            ...
            <div class="relative w-1/2">
                ...
                <input type="text" id="input-group-search"
                    ...
                    placeholder="Buscar Comida" onkeyup="filterFunction()">
                <button type="submit"
        ...
        <div id="foods" class="my-6 mx-4 grid grid-cols-4 gap-4">
            ...
            @foreach ($foods as $food)
                <div
                    class="food-display max-w-sm h-2/5 bg-white rounded-lg border border-gray-200 shadow-md dark:bg-gray-800 dark:border-gray-700">
                    <div class="h-4/6 flex items-center justify-center">
                        <a href="#" class="">
                            <img class="rounded-t-lg object-contain h-1/3" src="{{ asset('img/' . $food->img) }}"
                                alt="" />
