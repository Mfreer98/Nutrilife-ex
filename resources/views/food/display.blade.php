                            ...
                            <div class="flex-auto overflow-y-auto relative py-6 px-6 lg:px-8">
                                ...
                                <form method="POST" action="{{route('food.store')}}" enctype="multipart/form-data">
                                    ...
                                    <div class="grid gap-6 mb-6 md:grid-cols-2">
                                        ...
                                        <div>
                                            <label for="protein"
                                                class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300">Proteinas</label>
                                        ...
                                        <div>
                                            <label for="fat"
                                                class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300">Grasa</label>
                                        ...
                                        <div>
                                            <label for="sodium"
                                                class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300">Sodio</label>
                                        ...
                                        <div>
                                            <label for="sugar"
                                                class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300">Azúcar</label>
        ...
        <div id="foods" class="my-6 mx-4 grid grid-cols-4 gap-4">
            ...
            <div
                ...
                <div class="  items-center justify-center">
                    <a data-modal-toggle="modal-details {{$food->name}}" class="flex items-center justify-center">
                        <img class="my-2 h-3/6 w-3/6 rounded-lg " src="{{ asset('img/' . $food->img) }}" alt="" />

                    </a>
                </div>

                <div class="p-5 flex items-center justify-center">
                    <a data-modal-toggle="modal-details {{$food->name}}">
                ...
                <div class="hidden z-50 fixed top-0 left-0 w-full h-modal outline-none overflow-x-hidden overflow-y-auto"
                    id="modal-details {{$food->name}}" tabindex="-1" aria-hidden="true">
                                ...
                                <div class="grid gap-6 mb-6 md:grid-cols-2">
                                    <div>
                                        ...
                                        <input type="text" id="name" aria-label="names"
                                            ...
                                            value="{{$food->name}}" disabled readonly>
                                    </div>
                                    <div>
                                        <label for="calories"
                                            class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300">Calorias</label>
                                        <input type="number" id="calories" name="calories"
                                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                            placeholder="" disabled value="{{$food->calories}}" required>
                                    </div>
                                    <div>
                                        <label for="carbs"
                                            class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300">Carbohidratos</label>
                                        <input type="number" id="carbs" name="carbs"
                                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                            placeholder="" disabled value="{{$food->carbs}}" required>
                                    </div>
                                    <div>
                                        <label for="protein"
                                            class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300">Proteinas</label>
                                        <input type="number" id="protein" name="protein"
                                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                            placeholder="" disabled value="{{$food->protein}}" required>
                                    </div>
                                    <div>
                                        <label for="fat"
                                            class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300">Grasa</label>
                                        <input type="number" id="fat" name="fat"
                                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                            placeholder="" value="{{$food->fat}}" disabled required>
                                    </div>
                                    <div>
                                        <label for="sodium"
                                            class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300">Sodio</label>
                                        <input type="number" id="sodium" name="sodium"
                                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                            placeholder="" value="{{$food->sodium}}" disabled required>
                                    </div>
                                    <div>
                                        <label for="sugar"
                                            class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300">Azúcar</label>
                                        <input type="number" id="sugar" name="sugar"
                                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                            placeholder="" value="{{$food->sugar}}" disabled required>
                                    </div>
