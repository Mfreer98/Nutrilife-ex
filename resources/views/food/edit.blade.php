...
<div class="px-4 py-4">
    <div
        ...
        <form class="space-y-6" action="{{route('food.update', $food)}}" method="POST">
            @method('PUT')
            @csrf
            <h5 class=" text-center text-xl font-medium text-gray-900 dark:text-white">Edit Food</h5>
            <div>
                ...
                <input
                    ...
                    aria-describedby="file_input_help" type="file" name="img" id="img" value="{{$food->img}}">
            ...
            <div>
                ...
                <input type="name" name="name" id="name"
                    ...
                    value="{{$food->name}}" placeholder="John Doe" required="">

            </div>
            <div>
                <input type="number" name="calories" id="calories"
                    class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer"
                    placeholder=" " required="" value="{{$food->calories}}">
                <label for="calories"
            ...
            <div>
                <input type="number" name="protein" id="protein"
                    class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer"
                    placeholder=" " required="" value="{{$food->protein}}">
                <label for="protein"
            ...
            <div>
                <input type="number" name="fat" id="fat"
                    class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer"
                    placeholder=" " required="" value="{{$food->fat}}">
                <label for="fat"
            ...
            <div>
                <input type="number" name="carbs" id="carbs"
                    class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer"
                    placeholder=" " required="" value="{{$food->carbs}}">
                <label for="carbs"
            ...
            <div>
                <input type="number" name="sugar" id="sugar"
                    class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer"
                    placeholder=" " required="" value="{{$food->sugar}}">
                <label for="sugar"
            ...
            <div>
                <input type="number" name="sodium" id="sodium"
                    class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer"
                    placeholder=" " required="" value="{{$food->sodium}}">
                <label for="sodium"
