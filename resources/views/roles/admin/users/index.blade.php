...
@section('content')
  ...
  @endif
    <div class ="py-4 px-4">
    <a href="{{route('roles.admin.users.create')}}">
                    ...
                    @foreach ($users as $user)
                        <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                            ...
                            <td class="flex  py-3 px-6 space-x-4">
                                <a href="{{route('roles.admin.users.edit',$user)}}" class="font-medium text-blue-600 dark:text-blue-500 hover:underline">Edit</a>
                                
                                <form action="{{route('roles.admin.users.destroy',$user)}}" method="POST" >
