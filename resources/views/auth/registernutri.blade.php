    ...
    <x-jet-authentication-card>
        ...
        <form method="POST" action="{{ route('register') }}" x-data="{ role: 3 }">
            ...
            <div class="mt-4">
                ...
                <x-jet-input id="tel" class="block mt-1 w-full" type="number" name="tel" :value="old('tel')"
                    required autofocus autocomplete="123456789" />
            </div>


            <div class="mt-4">

                <x-jet-input id="role" class="block mt-1 w-full invisible " type="text" name="role"
                    :value="3" />
            </div>
